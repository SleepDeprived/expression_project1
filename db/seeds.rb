...
stage1 = Stage.create(  name: "Stage 1",  time_range: "0 - 15 min AEL",       order: 1)
stage2 = Stage.create(  name: "Stage 2",  time_range: "15 - 70 min AEL",      order: 2)
stage3 = Stage.create(  name: "Stage 3",  time_range: "70 - 90 min AEL",      order: 3)
stage4 = Stage.create(  name: "Stage 4",  time_range: "90 - 130 min AEL",     order: 4)
stage5 = Stage.create(  name: "Stage 5",  time_range: "130 - 180 min AEL",    order: 5)
stage6 = Stage.create(  name: "Stage 6",  time_range: "180 - 195 min AEL",    order: 6)
stage7 = Stage.create(  name: "Stage 7",  time_range: "195- 200 min AEL",     order: 7)
stage8 = Stage.create(  name: "Stage 8",  time_range: "200 - 230 min AEL",    order: 8)
stage9 = Stage.create(  name: "Stage 9",  time_range: "230 - 260 min AEL",    order: 9)
stage10 = Stage.create( name: "Stage 10", time_range: "260 - 320 min AEL",    order: 10)
stage11 = Stage.create( name: "Stage 11", time_range: "320 - 440 min AEL",    order: 11)
stage12 = Stage.create( name: "Stage 12", time_range: "440 - 580 min AEL",    order: 12)
stage13 = Stage.create( name: "Stage 13", time_range: "560 - 620 min AEL",    order: 13)
stage14 = Stage.create( name: "Stage 14", time_range: "620 - 680 min AEL",    order: 14)
stage15 = Stage.create( name: "Stage 15", time_range: "680 - 800 min AEL",    order: 15)
stage16 = Stage.create( name: "Stage 16", time_range: "800 - 900 min AEL",    order: 16)
stage17 = Stage.create( name: "Stage 17", time_range: "15 - 22 hours AEL",    order: 17)
